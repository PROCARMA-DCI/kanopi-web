...
export function IndustrySection() {
  ...
  return (
    ...
    <section className="industry" id="industry">
      ...
      <p className="industry__subtitle">
        because you&apos;re paying more than you should.
      </p>

      <div className="industry__text">
        <p>
          Most vehicle service contracts are sold at the time of sale of a car
          to you. There are lots of commissions and fees added to the final
          product that have no benefit to you as the consumer.{" "}
          <strong>Kanopi removes all of these.</strong>
        </p>
      </div>
      ...
      <div
        className="industry__wrapper-img"
        dangerouslySetInnerHTML={{ __html: animSvg }}
      />

      {/* Mobile animated SVG */}
      <div
        className="industry__wrapper-imgM"
        dangerouslySetInnerHTML={{ __html: animSvgM }}
      />

      <p className="industry__tagline">
        Kanopi cuts out the middle man, <strong>saving you $$$</strong>, and
        reinvesting in our planet.
      </p>
    </section>
  );
}
