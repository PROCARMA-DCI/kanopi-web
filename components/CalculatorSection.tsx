    ...
    <section className="calculator" id="calculator">
      ...
      <div className="calculator__inner">
        <div className="calculator__box">
          <h2 className="calculator__title anim-left">How much did you pay for...</h2>

          <div className="calculator__fields">
            <div className="calculator__box-input calculator__box-input-1">
              <p className="calculator__input-text anim-left">Vehicle Service Contract (Mechanical Coverage)</p>
              <div className="calculator__wrapper-input">
                ...
                <div className="calculator__wrapper-hint">
                  <Image
                    ...
                    alt="hint"
                  />
                  <p className="calculator__hint-text">This is the cost of your mechanical breakdown protection plan.</p>
                </div>
              </div>
            </div>

            <div className="calculator__box-input calculator__box-input-2">
              <p className="calculator__input-text">Tire &amp; Wheel Protection</p>
              <div className="calculator__wrapper-input">
                <input className="calculator__input" type="text" data-input />
              </div>
            </div>
          ...
          <div className="calculator__box-price">
            ...
            <p className="calculator__price h2-style">$<span className="calculator__price-text">0</span></p>
          </div>
        </div>

        <div className="calculator__img">
          <div className="calculator__img-inner" dangerouslySetInnerHTML={{ __html: carSvg }} />
        </div>
      </div>
    </section>
  );
