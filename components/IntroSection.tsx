...
import { IntroCheckDealButton } from "./IntroCheckDealButton";
...
export function IntroSection() {
  ...
  return (
    // id="intro" → reachable from anywhere via useScroll().scrollTo("intro")
    <section className="intro" id="intro">
      <div className="container_animation">
        {/* Cloud SVG — absolutely positioned at top */}
        <div
          className="box-clouds"
        ...
        <div className="text">
          ...
          {/* Scrolls into the rate-check flow via the shared ScrollProvider. */}
          <IntroCheckDealButton />
        </div>
